...
public class ActCadCliente extends AppCompatActivity {
    ...
    //atributo necessário ao Snackbar
    private ConstraintLayout layoutContentActCadCliente;
    //atributos necessários para conexao com banco de dados
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Linha 51: chama o método para criar conexao com o BD
        criarConexao();
    ...
    private void criarConexao(){
        ...
        try {
            ...
            Snackbar.make(layoutContentActCadCliente, R.string.message_conexao_ok, Snackbar.LENGTH_LONG ).setAction(R.string.action_ok,null).show();

            //linha 62: instancia um objeto da classe ClienteRepositorio para criar a conexao com o BD e habilitar o CRUD
    ...
    private boolean validaCampos(){
        ...
        if (res){
            ...
            dlg.setMessage(R.string.message_campos_invalidos_ou_brancos);
            dlg.setNeutralButton(R.string.action_ok, null);
            dlg.show();
